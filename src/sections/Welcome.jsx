        ...
        <div className="content flex flex-col justify-between items-center h-[83%]">
          ...
          <div className="middle-text">
            ...
            <div className="bg-white flex justify-between items-center px-1 py-2 rounded-full w-[90%] my-0 mx-auto">
              ...
              <input
                className="bg-transparent text-center w-[90%] text-[12px] focus:outline-none"
                type="text"
          ...
          <div className="bottom-text relative z-20">
            <Link to="/home">
              <a className="bg-white p-1 rounded-md cursor-pointer px-4 py-2 text-sm text-gray-400 font-semibold">
                Get Started
              </a>
            </Link>

            <p className="text-white text-center text-sm cursor-pointer mt-2">
              Need Help?
            </p>
          </div>
        </div>
